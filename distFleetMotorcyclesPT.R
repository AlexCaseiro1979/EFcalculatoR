...
segments[[1]] <- c('Motorcycles 2-stroke >50 cm\374', 'Motorcycles 4-stroke <250 cm\374',
                   'Motorcycles 4-stroke 250 - 750 cm\374', 'Motorcycles 4-stroke >750 cm\374', 'Quad & ATVs', 'Micro-car')
segments_fraction[[1]] <- c(0.548, 0.027, 0.049+0.060, 0.314, 0.001, 0.001)
...
euro_standards_fraction[[1]] <- c(0, 0, 0.14, 0.233, 0.223, 0.172+0.155+0.076)
