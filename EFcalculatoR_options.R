...
# the third variable for the function is the slope
...
# the fourth variable for the function is the load
# Options are: 0.0, 0.5, 1.0
# this only makes sense for categories Heavy Duty Trucks and Buses
# keep NA for categories Passenger Cars and Light Commercial Vehicles

# the fifth variable for the function are the pollutants
...
# the sixth variable for the function are the driving modes to be discriminated here.
...
# the seventh variable is the fleet distribution file

EFfunc('Test01', 120, NA, NA,
        c('CO', 'NOx'), c('', ''),
        'distLightweight.R')
EFfunc('Test02', 120, NA, NA,
        c('CO', 'NOx', 'PM Exhaust'),
        c('', '', 'Highway'),
        'distLightweight.R')
EFfunc('Test03', 120, NA, NA,
        c('CO', 'NOx', 'PM Exhaust', 'VOC'),
        c('', '', 'Highway', ''),
        'distLightweight.R')
EFfunc('Test04', 120, NA, NA,
        c('CO', 'NOx', 'PM Exhaust', 'VOC', 'FC', 'CH4'),
        c('', '', 'Highway', '', '', 'Highway'),
        'distLightweight.R')
EFfunc('Test05', 80, 0.02, 0.5,
        c('CO'),
        c(''),
        'distTrucks.R')
EFfunc('Test06', 80, 0.02, 0.5,
        c('CO', 'NOx'),
        c('', ''),
        'distTrucks.R')
EFfunc('Test07', 80, 0.02, 0.5,
        c('CO', 'NOx', 'PM Exhaust'),
        c('', '', 'Highway'),
        'distTrucks.R')
